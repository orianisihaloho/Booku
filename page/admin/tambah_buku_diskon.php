...
$diskon_ = ($_POST['harga'] * $_POST['diskon']) / 100;
$total = $_POST['harga'] - $diskon_ ;
...
if($_FILES['gambar']['name']){
	...
	if(!$_FILES['gambar']['error']){
		...
		if($valid_file == true)
		{
			...
			// simpan ke database
			mysql_query("INSERT into diskon set judul='$judul',id_kategori='$id_kategori',id_katalog='$id_katalog',pengarang='$pengarang',penerbit='$penerbit',hal='$halaman',harga='$harga',deskripsi='$deskripsi',tanggal='$tanggal',diskon='$diskon',harga_diskon='$total',gambar='$nama_file_baru'");
