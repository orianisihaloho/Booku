...
//        koneksi ke database
		...
		//$qrybayar = mysql_query("SELECT * from diskon where id_buku_diskon='$id_buku_diskon'");
		//$databayar = mysql_fetch_array($qrybayar);
//       query
        $sql =  "SELECT * FROM diskon ORDER BY judul";
        $result = mysql_query($sql);
        
        //pagination config start
        $rpp = 5; // jumlah record per halaman
        $reload = "buku_diskon.php?page=&pagination=true";
...
$no =1;
  ...
  <tr>
      ...
      <td><center><?php $qrystok_diskon= mysql_query("SELECT * from stok_diskon where id_buku_diskon='$data[id_buku_diskon]'");$data_stok=mysql_fetch_array($qrystok_diskon);$stok_diskon=$data_stok['stok_diskon']; echo $stok_diskon;if($stok_diskon==""){ ?>
        <a href="#" class='open_modal_tstok' id='<?php echo  $data['id_buku_diskon']; ?>'><span class="glyphicon glyphicon-plus"></span></a> <?php }else{?>
        <a href="#" class='open_modal_stok' id='<?php echo  $data['id_buku_diskon']; ?>'><span class="glyphicon glyphicon-pencil"></span></a><?php } ?> </center>
      </td>
	  <td><input type="text" name="harga_diskon"  class="form-control"  value="<?php echo $data['harga_diskon']; ?>"readonly >
    </td>
      <td>
      <center>
	  
         <a href="#" class='open_modal btn btn-info' id='<?php echo  $data['id_buku_diskon']; ?>'><span class="glyphicon glyphicon-pencil"></span></a>
         <a href="#" class="btn btn-danger" onclick="confirm_modal('del_buk_diskon.php?&id=<?php echo  $data['id_buku_diskon']; ?>');"><span class="glyphicon glyphicon-trash"></span></a>
      </center>
      </td>
  </tr>
<?php
    ...
    <div class="modal-content">
      ...
      <div class="modal-header" style="text-align:center;background:#4682b5;color:#fff;color:#fff;">
        ...
        <div class="modal-body">
          <form action="tambah_buku_diskon.php" name="modal_popup" enctype="multipart/form-data" method="POST">
