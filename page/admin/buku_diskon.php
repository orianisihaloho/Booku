<?php
include"../../db.php";
$qrybuku = mysql_query("SELECT * from diskon");
@$act = $_GET['act'];
if($act=="tambah"){
	include("tambah_buku_diskon.php");
}
else if($act=="edit")
{
	include("edit_buku_diskon.php");
}
else if($act=="hapus")
{
	$id = $_GET['id'];
	mysql_query("DELETE from diskon where id_buku_diskon='$id'");
	header("location:index.php?page=buku");
}
else if($act=="tampildiskon")
{
	include("atur_diskon.php");
}
?>
<?php
include"../../db.php";
