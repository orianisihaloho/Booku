...
<tr>
	<td><?php $id_buku = $isi_keranjang['id_buku']; $qrybuku=mysql_query("SELECT * from buku where id_buku='$id_buku'"); 
	$data_buku=mysql_fetch_array($qrybuku); 
	$judul = $data_buku['judul']; echo $judul;?></td>
