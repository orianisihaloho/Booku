...
$kd = $_GET['id'];
session_start();
$q_detail = mysql_query("SELECT * from diskon where id_buku_diskon='$kd'");
...
<div class="modal-dialog">
      <div class="modal-content">
            ...
            <div class="row">
                  ...
                  <tr>
                  <td><p>Diskon</td><td>: <?php echo number_format($detail['diskon'])?> % </p></td>
                  </tr>
				   <tr>
                  <td><p>Harga Diskon</td><td>: <?php echo number_format($detail['harga_diskon'])?>,-</p></td>
                  </tr>
                  </table>
                  </div>
                  </div>
            </div>
            <center><i style="font-size:20px;">Deskripsi :</i><p><?php echo $detail['deskripsi']; ?></p>
            </div>
            <div class="modal-footer">
            <form action="t_transaksi.php" method="post">
            <input type="hidden" name="id_buku_diskon" value="<?php echo $detail['id_buku_diskon']; ?>" style="width:10px;">
            <input type="hidden" name="harga" value="<?php echo $detail['harga']; ?>"  style="width:10px;">
              <?php
              $qrystok = mysql_query("SELECT * FROM stok_diskon where id_buku_diskon='$detail[id_buku_diskon]'");
