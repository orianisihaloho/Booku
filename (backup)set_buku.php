...
<form name="FEdit" method="post" action="insert_buku_diskon.php" onSubmit="return confirm('Insert data buku terpilih ke List Buku Diskon?')\">  
...
$no =1;
  ...
  ?>
  <tr>
	  <td><input type="checkbox" name="item[]" id="item[]" value="'.$rec->judul.'" /></td>
...
<p align="center"><input name="insert" type="submit" value="INSERT"></p>
</form>
</div>
